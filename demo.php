...
if (isset($_POST['send'])) {
    ...
    $msg = '<html><body>';
    $msg .= '<h2>Demo Application Form Details:</h2>';
    ...
    try {
        ...
        $mail->Subject = 'New Demo Application Received';
        $mail->isHTML(true);
        $mail->Body = $msg;
        ...
        <div class="row py-5 justify-content-center align-items-center">
            ...
            <div class="col-lg-6 col-md-8 col-sm-10">
                <div class="form-container"
                    style="background: #fff; padding: 30px; border-radius: 8px; box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.1);">
                    <h3 class="text-center" style="color: #6f42c1;"><strong>Book Demo Class</strong></h3>
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="mb-3">
                            <label class="form-label" style="color: #6f42c1; font-weight: bold;">Full Name</label>
                            <input type="text" name="fullname" id="fullName" class="form-control"
                                placeholder="Enter Full Name" required style="border-color: #6f42c1;">
                        </div>
                        ...
                        <div class="mb-3">
                            <label class="form-label" style="color: #6f42c1; font-weight: bold;">Course</label>
                            <select name="course" class="form-select" required style="border-color: #6f42c1;">
                        ...
                        <div class="mb-3">
                            <label class="form-label" style="color: #6f42c1; font-weight: bold;">Mode</label>
                            <select name="mode" class="form-select" required style="border-color: #6f42c1;">
            ...
            <!-- Right Side: Image -->
            <div class="col-lg-6 col-md-8 col-sm-10 d-flex justify-content-center py-4 mt-lg-0">
                <img src="./images/demo-img.png" alt="Job Application" class="img-fluid"
    ...
    <div class="position-fixed top-0 end-0 p-3" style="z-index: 1050;">
        <div id="successToast" class="toast bg-success text-white" role="alert" aria-live="assertive"
            ...
            <div class="toast-body">
                You have successfully booked demo class! Our team will contact you as soon as possible.
            </div>
        </div>
    </div>
